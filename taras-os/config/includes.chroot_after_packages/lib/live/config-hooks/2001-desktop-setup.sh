...
Categories=System;
Icon=calamares
Name=Встановити Taras OS
GenericName=Засіб встановлення системи
Comment=Встановити цей респін Debian на диск
Exec=sudo calamares
Keywords=install;system;tarasos;встановити;система;інсталятор
EOF
...
for file in "Корисно знати.md" "Errata.md" "(ОБЕРЕЖНО) Створити persistence розділ.sh"
do
